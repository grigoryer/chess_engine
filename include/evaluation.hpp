...
class Evaluation
{
	inline Score scoreLeaperPosition(Piece piece, Square sq, bool isLateGame);
	inline Score scoreSliderPosition(Piece piece, Square sq, bool isLateGame, Board& b, Side Side);
public: 
